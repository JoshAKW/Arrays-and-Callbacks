...
const multiply = (num1, num2, cbf) => cbf(num1 * num2)
...
first(names, cbf => {
  console.log('The first name in names is ' + cbf)
})
...
const last = (arr, cbf) => cbf(arr[arr.length -1])
...
const contains = (arr, name, cbf) => name ? cbf(true) : cbf(false)
...
contains(names, 'Colt', result => result === true ? console.log('Colt is in the array') : console.log('Colt is not in the array'))
...
const addTwentySix = (addingFactory(26))

console.log(addTwentySix(15))