...
// CODE HERE
const totalPopulation = populations.reduce((prV, cuV) => prV + cuV)
...
const orderSalesTax = orders.map(total => total.price + total.tax)

console.log(orderSalesTax)
...
// CODE HERE
const sumTotal = purchases.filter(bob => bob.owner === "Bob").reduce((prV,newV) => prV + newV.price,0)
